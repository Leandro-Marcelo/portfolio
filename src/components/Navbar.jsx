  ...
  return (
    ...
    <div className="sticky top-0 w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      ...
      <div className="hidden md:flex">
        {/* escuende los dos porque quizás puede seguir dando interactividad o por qué será xd */}
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
            ...
            <a
              href="https://www.linkedin.com/in/leandro-marcelo/"
              target="_blank"
              rel="noreferrer"
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333]">
            <a
              href="https://github.com/Leandro-Marcelo"
              target="_blank"
              rel="noreferrer"
              className="flex justify-between items-center w-full text-gray-300"
            >
